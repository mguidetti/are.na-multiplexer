...
function Header () {
  ...
  return (
    <div className='flex gap-x-4 py-2 px-3 items-start bg-background text-primary/70'>
      <div className='w-64 flex align-middle gap-x-2'>
        ...
        <span className="font-mono text-sm">SHELF OS</span>
      </div>
